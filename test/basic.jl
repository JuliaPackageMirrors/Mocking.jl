...
let anonymous = () -> "foo"
    ...
    if Mocking.isgeneric(anonymous)
...
let t = temp
    ...
    # Attempting to add new method or override one will restrict the method table to only
    # contain functions defined within the scope of the let
